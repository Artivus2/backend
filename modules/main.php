        ...
        'items' => [
			[
				...
				'items' => [
                    ...
                    ['visible' => !Yii::$app->user->isGuest, 'label' => '<span class="glyphicon glyphicon-user"></span> Список заявок на вывод', 'url' => ['/admin/sell/index']],
                    //['visible' => !Yii::$app->user->isGuest, 'label' => '<span class="glyphicon glyphicon-user"></span> Верификация клиентов', 'url' => ['/admin/verify/index']],
